...
function AnimatedTicks(_ref) {
  ...
  var animatedTicks = (0, _reactSpring.useTransition)(ticks, _extends({}, (0, _useLineTransitionConfig.default)({
    scale: scale,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, animatedTicks(function (_ref2, item, _ref3, index) {
    ...
    return item == null || key == null ? null : /*#__PURE__*/_react.default.createElement(_reactSpring.animated.g, {
      ...
      key: index,
      transform: (0, _reactSpring.to)([toX, toY], function (interpolatedX, interpolatedY) {
