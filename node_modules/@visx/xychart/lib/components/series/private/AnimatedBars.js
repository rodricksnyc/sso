...
function AnimatedBars(_ref4) {
  ...
  var animatedBars = (0, _reactSpring.useTransition)(bars, _extends({}, useBarTransitionConfig({
  ...
  return (
    ...
    _react.default.createElement(_react.default.Fragment, null, animatedBars(function ( // @ts-expect-error x/y aren't in react-spring types (which are HTML CSS properties)
    _ref5, item, _ref6) {
      var x = _ref5.x,
          y = _ref5.y,
          width = _ref5.width,
