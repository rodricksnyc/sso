...
export var INDICATOR_SPACER = '8px';
export var NavTree = styled(function (_ref) {
  ...
  var renderedIndicator = cloneElement(indicator, _objectSpread({}, isIndicatorToggleOnly ? indicatorToggleOnlyProps : undefined));
  var handleContentBlur = useWrapEvent(function (event) {
    if (!isIndicatorToggleOnly && onBlurDisclosureToggle) onBlurDisclosureToggle(event);
  });
  var handleContentClick = useWrapEvent(function (event) {
    if (!isIndicatorToggleOnly && onClickDisclosureToggle) onClickDisclosureToggle(event);
  }, onClick);
  var handleContentKeyUp = useWrapEvent(function (event) {
  ...
  var content = React.createElement(React.Fragment, null, isIndicatorToggleOnly && renderedIndicator, React.createElement(NavTreeItemContent, _extends({
    "aria-selected": selected,
    href: href,
...
})(["", "{padding-left:", ";", "}"], AccordionIndicator, INDICATOR_SPACER, function (_ref3) {
  var icon = _ref3.icon,
      theme = _ref3.theme;
  return !icon && "margin-right: ".concat(theme.space[listItemDimensions(theme.defaults.density).iconGap], ";");
});
