...
const generateBorderRadius = (borderRadius, theme) => {
  const radii = theme.radii;
  return (0, _styledComponents.css)(["", ",", "{border-radius:", ";}"], _TreeItemContent.TreeItemContent, _LkFieldItemLabel.LkFieldItemLabel, radii[borderRadius]);
};
