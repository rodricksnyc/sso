...
const AvatarButton = (0, _styledComponents.default)((0, _react.forwardRef)((_ref, forwardedRef) => {
  ...
  const _useTranslation = (0, _utils.useTranslation)('AvatarButton'),
        t = _useTranslation.t;
...
})(["position:relative;img{border-radius:50%;height:", ";position:absolute;width:", ";}"], ({
  theme
}) => theme.sizes.medium, ({
  theme
}) => theme.sizes.medium);
