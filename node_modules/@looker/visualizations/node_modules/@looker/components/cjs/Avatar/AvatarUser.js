...
const AvatarLayout = _ref => {
  ...
  const _useTranslation = (0, _utils.useTranslation)('AvatarUser'),
        t = _useTranslation.t;
  ...
  return _react.default.createElement(BaseElement, _extends({}, (0, _designTokens.omitStyledProps)(props), {
    ...
    color: color,
    "aria-hidden": true
  }, size === 'xxsmall' ? `${firstInitial}` : `${firstInitial}${lastInitial}`), user && user.avatar_url && !imgError && _react.default.createElement(AvatarPhoto, {
    "aria-hidden": true,
    onError: handleError,
...
const AvatarPhoto = _styledComponents.default.img.withConfig({
