...
var ExternalLinkIndicator = styled(Launch).withConfig({
  displayName: "Link__ExternalLinkIndicator",
  componentId: "sc-165dqum-0"
})(["height:", ";margin-left:", ";width:", ";"], function (_ref) {
...
var LinkLayout = forwardRef(function (props, ref) {
  var children = props.children,
      isExternal = props.isExternal,
      restProps = _objectWithoutProperties(props, _excluded);

  var enhancedRel = generateLinkTypes(props);
  return React.createElement("a", _extends({}, omit(omitStyledProps(restProps), [].concat(linkStyleProps, ['dangerouslyDisableRel'])), {
    ref: ref,
    rel: enhancedRel
...
})(["", " ", " color:", ";text-decoration:", ";&[aria-expanded='true'],&:focus,&:hover,&:active,&.active,&:visited{color:", ";outline:none;text-decoration:", ";}"], reset, typography, function (_ref5) {
