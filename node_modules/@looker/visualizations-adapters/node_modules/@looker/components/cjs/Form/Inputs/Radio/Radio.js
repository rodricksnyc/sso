...
const Radio = (0, _styledComponents.default)((0, _react.forwardRef)((props, ref) => {
...
})(["", " ", " ", " align-items:center;display:flex;height:", ";justify-content:center;position:relative;width:", ";input{height:100%;left:0;margin:0;opacity:0;position:absolute;top:0;width:100%;z-index:1;&:checked + ", "{color:", ";&::after{background:currentColor;}}&[aria-invalid='true'] + ", "{color:", ";}&:disabled{cursor:not-allowed;+ ", ",&:not(:checked):hover + ", "{color:", ";}}&:not(:checked):not([aria-invalid='true']):not(:disabled){&:hover,&:focus{+ ", "{color:", ";}}}}"], _designTokens.reset, _designTokens.space, _Ripple.rippleStyle, ({
  theme: {
    space
  }
}) => space.u6, ({
...
}) => space.u6, _FauxRadio.FauxRadio, ({
  theme
}) => theme.colors.key, _FauxRadio.FauxRadio, ({
  theme
}) => theme.colors.critical, _FauxRadio.FauxRadio, _FauxRadio.FauxRadio, ({
  theme
}) => theme.colors.ui2, _FauxRadio.FauxRadio, ({
  theme
}) => theme.colors.ui5);
exports.Radio = Radio;
