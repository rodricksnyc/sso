...
export var seriesPointStyle = function seriesPointStyle(_ref) {
  ...
  var buildArraySeries = function buildArraySeries() {
    ...
    for (var i = 0; i < measures.length; i++) {
      var _ref2 = arraySeries[i] || {},
          ...
          style = _ref2$style === void 0 ? normalizedPointStyle : _ref2$style;
  ...
  var buildNamedSeries = function buildNamedSeries(s) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var style = get(namedSeries, [field, 'style'], normalizedPointStyle);
