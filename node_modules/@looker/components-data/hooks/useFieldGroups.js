...
var fetchModelExplore = memoize(function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(model, explore, sdk) {
    var result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return sdk.lookml_model_explore(model, explore, 'fields');
...
export var useFieldGroups = function useFieldGroups(id) {
  var sdk = useSDK();
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt("return", fetchModelExplore(model, view, sdk));
  ...
  var _useSWR = useSWR("useFieldGroups-".concat(model, "-").concat(view), fetcher),
      SWRData = _useSWR.data,
      isValidating = _useSWR.isValidating;

  useEffect(function () {
    var _ref3 = (SWRData === null || SWRData === void 0 ? void 0 : SWRData.ok) && SWRData.value || {},
