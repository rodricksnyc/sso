...
const fetchQueryId = (0, _memoize.default)(function () {
  var _ref = _asyncToGenerator(function* (slug, sdk) {
    const result = yield sdk.query_for_slug(slug);
    return result;
  });
...
const useQueryId = (slugOrId = '') => {
  ...
  const cachedQuery = (0, _react.useMemo)(() => getById(queryId, 'metadata') || {}, [getById, queryId]);
  ...
  const _useSWR = (0, _swr.default)(`useQueryId-${querySlug}`, fetcher),
  ...
  (0, _react.useEffect)(() => {
    const _ref3 = SWRData !== null && SWRData !== void 0 && SWRData.ok ? SWRData.value : {},
          id = _ref3.id,
          SWRValue = _objectWithoutProperties(_ref3, _excluded);
