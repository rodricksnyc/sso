...
export var splitInputValue = function splitInputValue(inputValue) {
...
export var validateValues = function validateValues(newValues, currentValues, validate, formatInputValue) {
  var duplicateValues = [];
  var invalidValues = [];
  var unusedValues = [];
  var validValues = [];
...
export var InputChips = styled(forwardRef(function (_ref, ref) {
