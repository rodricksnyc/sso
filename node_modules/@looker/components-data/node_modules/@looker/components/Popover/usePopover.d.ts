...
export declare const usePopover: ({ "aria-haspopup": ariaHaspopup, canClose, content, disabled, pin, isOpen: controlledIsOpen, onClose, placement: propsPlacement, setOpen: controlledSetOpen, triggerElement, triggerToggle, focusTrap, scrollLock, cancelClickOutside, ref, surface, width, id, }: UsePopoverProps) => {
