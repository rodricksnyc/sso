...
})(["", " font-family:inherit;font-size:", ";line-height:", ";padding:0;text-align:center;width:", ";&:focus{background:", ";}"], _innerInputStyle.innerInputStyle, ({
  theme
...
})(["", " ", " align-items:center;display:inline-grid;grid-gap:0.15rem;grid-template-columns:auto auto auto auto 1fr;height:", ";padding:", ";", "{justify-self:end;}&:focus-within{", "}&:hover{", "}&.disabled{", "}", ""], _simple.simpleLayoutCSS, _InputText.inputCSS, _height.inputHeight, ({
  theme: {
    space
  }
}) => `${space.u05} ${space.u1} ${space.u05} ${space.u3}`, _InputText.InputTextContent, _InputText.inputTextFocus, _InputText.inputTextHover, _InputText.inputTextDisabled, _InputText.inputTextValidation);
