...
import { mergeClassNames, useCallbackRef, useMeasuredElement, useWrapEvent } from '../utils';
export var Indicator = styled.span.withConfig({
  displayName: "Tab2__Indicator",
  componentId: "sc-qok8xr-0"
})(["background-color:", ";border-radius:3px 3px 0 0;height:3px;margin-top:", ";padding-left:", ";padding-right:", ";width:100%;"], function (_ref) {
...
export var Tab2 = styled(forwardRef(function (props, forwardedRef) {
  ...
  var rippleHandlers = useRippleHandlers(callbacks, _objectSpread({}, pick(restProps, rippleHandlerKeys)), disabled);
  ...
  return React.createElement("button", _extends({
    ...
    tabIndex: -1,
    type: "button"
  }, restProps, rippleHandlers), React.createElement("span", null, children), React.createElement(Indicator, {
    selected: selected
  }));
})).attrs(function (_ref5) {
  var _ref5$fontFamily = _ref5.fontFamily,
      fontFamily = _ref5$fontFamily === void 0 ? 'brand' : _ref5$fontFamily,
      _ref5$fontSize = _ref5.fontSize,
      fontSize = _ref5$fontSize === void 0 ? 'small' : _ref5$fontSize,
      _ref5$fontWeight = _ref5.fontWeight,
      fontWeight = _ref5$fontWeight === void 0 ? 'medium' : _ref5$fontWeight;
  return {
  ...
  displayName: "Tab2",
  componentId: "sc-qok8xr-1"
})(["", " ", " ", " ", " ", " align-items:center;background:transparent;border:none;color:", ";cursor:pointer;display:inline-flex;flex-direction:column;height:", ";justify-content:flex-end;margin:0;min-width:fit-content;padding-left:", ";padding-right:", ";", ""], reset, layout, padding, rippleStyle, typography, function (_ref6) {
  ...
  return disabled && css(["border-bottom-color:transparent;color:", ";cursor:default;"], function (_ref11) {
