...
exports.Tab2 = exports.Indicator = void 0;
...
})(["background-color:", ";border-radius:3px 3px 0 0;height:3px;margin-top:", ";padding-left:", ";padding-right:", ";width:100%;"], ({
  selected,
  theme
...
const Tab2 = (0, _styledComponents.default)((0, _react.forwardRef)((props, forwardedRef) => {
  ...
  const rippleHandlers = (0, _Ripple.useRippleHandlers)(callbacks, _objectSpread({}, (0, _pick.default)(restProps, _Ripple.rippleHandlerKeys)), disabled);
  ...
  return _react.default.createElement("button", _extends({
    ...
    tabIndex: -1,
    type: "button"
  }, restProps, rippleHandlers), _react.default.createElement("span", null, children), _react.default.createElement(Indicator, {
    selected: selected
  }));
})).attrs(({
  fontFamily = 'brand',
...
})(["", " ", " ", " ", " ", " align-items:center;background:transparent;border:none;color:", ";cursor:pointer;display:inline-flex;flex-direction:column;height:", ";justify-content:flex-end;margin:0;min-width:fit-content;padding-left:", ";padding-right:", ";", ""], _designTokens.reset, _designTokens.layout, _designTokens.padding, _Ripple.rippleStyle, _designTokens.typography, ({
  selected,
  theme
  ...
  disabled
}) => disabled && (0, _styledComponents.css)(["border-bottom-color:transparent;color:", ";cursor:default;"], ({
  theme
}) => theme.colors.text1));
exports.Tab2 = Tab2;
