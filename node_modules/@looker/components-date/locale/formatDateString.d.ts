...
export declare const formatDateString: (date?: Date | undefined, locale?: Locale, stringFormat?: DateFormats | string, timeZone?: undefined | string, options?: DateTimeOptions) => string | '';
export {};
