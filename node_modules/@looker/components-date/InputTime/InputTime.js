...
import { ErrorIcon, getAutoFocusProps, InputTextContent, inputCSS, inputHeight, innerInputStyle, inputTextHover, inputTextFocus, inputTextDisabled, inputTextValidation, simpleLayoutCSS } from '@looker/components';
...
})(["", " font-family:inherit;font-size:", ";line-height:", ";padding:0;text-align:center;width:", ";&:focus{background:", ";}"], innerInputStyle, function (_ref3) {
...
})(["", " ", " align-items:center;display:inline-grid;grid-gap:0.15rem;grid-template-columns:auto auto auto auto 1fr;height:", ";padding:", ";", "{justify-self:end;}&:focus-within{", "}&:hover{", "}&.disabled{", "}", ""], simpleLayoutCSS, inputCSS, inputHeight, function (_ref7) {
  var space = _ref7.theme.space;
  return "".concat(space.u05, " ").concat(space.u1, " ").concat(space.u05, " ").concat(space.u3);
}, InputTextContent, inputTextFocus, inputTextHover, inputTextDisabled, inputTextValidation);
