...
const InputDateRange = (0, _react.forwardRef)(({
  ...
  const _useState7 = (0, _react.useState)((0, _locale.formatDateString)(dateRange.from, locale, dateStringFormat)),
  ...
  const _useState11 = (0, _react.useState)((0, _locale.formatDateString)(dateRange.to, locale, dateStringFormat)),
  ...
  (0, _react.useEffect)(() => {
    if (value && !(0, _isEqual.default)(value, dateRange)) {
      setDateRange(value);
      value.from && inputs.from.setValue((0, _locale.formatDateString)(value.from, locale, dateStringFormat));
      value.to && inputs.to.setValue((0, _locale.formatDateString)(value.to, locale, dateStringFormat));
  ...
  const handleDateChange = (datesToSet, date) => {
    ...
    inputs[nonActiveInput].setValue((0, _locale.formatDateString)(newDateRange[nonActiveInput], locale, dateStringFormat));
  ...
  const handleCalendarClick = date => {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        const d = _step.value;
        inputs[d].setValue((0, _locale.formatDateString)(date, locale, dateStringFormat));
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
  ...
  return _react.default.createElement(InputDateRangeWrapper, {
    ...
    placeholder: `${(0, _locale.formatDateString)(new Date(Date.now()), locale, dateStringFormat)}`,
    disabled: disabled,
