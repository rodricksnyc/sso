...
const InputTimeInternal = (0, _react.forwardRef)(({
  ...
  return _react.default.createElement("div", {
    ...
    readOnly: readOnly,
    required: required
  }, (0, _components.getAutoFocusProps)(autoFocus))), _react.default.createElement("div", null, ":"), _react.default.createElement(StyledInput, {
    value: minute,
    ...
    readOnly: readOnly,
    required: required
  }) : _react.default.createElement("span", null), validationType && _react.default.createElement(_components.InputTextContent, {
    pr: "u2"
  }, _react.default.createElement(_components.ErrorIcon, null)));
});
...
const StyledInput = _styledComponents.default.input.withConfig({
  ...
  componentId: "sc-1q4mxxj-0"
})(["", " font-family:inherit;font-size:", ";line-height:", ";padding:0;text-align:center;width:", ";&:focus{background:", ";}"], _components.innerInputStyle, ({
  theme
...
const InputTime = (0, _styledComponents.default)(InputTimeInternal).withConfig({
  ...
  componentId: "sc-1q4mxxj-1"
})(["", " ", " align-items:center;display:inline-grid;grid-gap:0.15rem;grid-template-columns:auto auto auto auto 1fr;height:", ";padding:", ";", "{justify-self:end;}&:focus-within{", "}&:hover{", "}&.disabled{", "}", ""], _components.simpleLayoutCSS, _components.inputCSS, _components.inputHeight, ({
  theme: {
    space
  }
}) => `${space.u05} ${space.u1} ${space.u05} ${space.u3}`, _components.InputTextContent, _components.inputTextFocus, _components.inputTextHover, _components.inputTextDisabled, _components.inputTextValidation);
