...
export var MIN_LABEL_SPACE = 90;
export var useLabelWidth = function useLabelWidth(measureTotal, keyValData, legend) {
  var _ref = legend || {},
      _ref$type = _ref.type,
      legendType = _ref$type === void 0 ? 'legend' : _ref$type;

  var theme = useContext(ThemeContext);
  var longestLabel = pickLongestLabel(Object.entries(keyValData).map(function (_ref2) {
    var _ref3 = _slicedToArray(_ref2, 2),
        key = _ref3[0],
        val = _ref3[1];

    return getLabelContent(measureTotal, _defineProperty({}, key, val), legend);
  }));

  var _useMeasuredText = useMeasuredText(longestLabel, {
