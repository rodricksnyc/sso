...
export var getLabelContent = function getLabelContent(measureTotal, data, legendConfig) {
  var _ref = legendConfig || {},
      _ref$value = _ref.value,
      value = _ref$value === void 0 ? 'label_percent' : _ref$value;

  var _Object$entries$ = _slicedToArray(Object.entries(data)[0], 2),
      key = _Object$entries$[0],
      val = _Object$entries$[1];

  var percent = numeral(val / measureTotal).format('0.00%');
  var labels = {
    label: key,
    value: String(val),
    percent: percent,
